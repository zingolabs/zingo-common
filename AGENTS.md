...
Issues and PRDs live in **GitHub Issues** (via the `gh` CLI). External pull
requests are also a triage surface. See `docs/agents/issue-tracker.md`.

### Triage labels

Five canonical triage roles, each mapped to a like-named label
